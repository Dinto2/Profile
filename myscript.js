...
function showSlidesG(n) {
  let i;
  let slidesG = document.getElementsByClassName("mySlides-g");
  let dotsG = document.getElementsByClassName("dot-g");
  ...
  for (i = 0; i < dotsG.length; i++) {
    dotsG[i].className = dotsG[i].className.replace(" active-g", "");
  }
  slidesG[slideIndexG-1].style.display = "block";  
  dotsG[slideIndexG-1].className += " active-g";
}
